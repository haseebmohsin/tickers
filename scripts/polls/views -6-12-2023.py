...
def index(request):
    if request.method=='POST':
            ...
            if searching_word and channel_name_search != 'option0' and date_search and not time_search and not date_search_end and not time_search_end:
                ...
                print('result',result)
            elif searching_word and channel_name_search != 'option0' and time_search and not date_search and not date_search_end and not time_search_end:
            ...
            elif searching_word and channel_name_search != 'option0' and time_search and date_search and not date_search_end and not time_search_end:
            ...
            # else :
                result=Ticker_Extraction_Model.objects.filter(text_ocr__icontains=str(searching_word)).order_by('-id')
    ...
    while success:
        ...
        if count % 60 == 0: 
            ...
            if len(text_ticker)>=6:
                ...
                all_objects = Ticker_Extraction_Model.objects.all().order_by('-id')[:5]
                ticker_write=True
