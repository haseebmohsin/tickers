    ...
    if len(get_words)>=1:
        ...
        for word, data_list in results_dict.items():
            ...
            if data_list:  # Make sure the data_list is not empty
                ...
                if first_data_for_word not in official_result and first_data_for_word not in notificationsList and clear_list_and_word==False:

                    official_result.append(first_data_for_word)
                    official_word.append(word)
                elif clear_list_and_word==True:
