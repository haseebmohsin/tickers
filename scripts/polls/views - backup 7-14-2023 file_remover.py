...
def dunya_ticker(request):
    ...
    if len(text_ticker)>=16:
        ...
        all_objects = Ticker_Extraction_Model.objects.all().order_by('-id')[:20]
        ticker_write=True
...
def geo_ticker(request):
    ...
    characters=streamer(source="https://www.youtube.com/watch?v=_Q6X1VylryE",y1=297,y2=335,x1=89,x2=550,folder_save='Geo_Ticker')            
...
def ninety_two_ticker(request):
    ...
    characters=streamer(source="https://www.youtube.com/watch?v=F0LPjtWUMak",y1=297,y2=335,x1=89,x2=550,folder_save='NinetyTwo_Ticker')            
